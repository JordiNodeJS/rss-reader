...
const THEME_METADATA = {
  'amber-minimal': { name: 'Amber Minimal', colors: ['#d4a656', '#f5f5f5', '#8b7355'] },
  'amethyst-haze': { name: 'Amethyst Haze', colors: ['#9276b2', '#e09cb7', '#6ecba6'] },
  ...
  'claymorphism': { name: 'Claymorphism', colors: ['#6366f1', '#fafafa', '#e5e7eb'] },
  'clean-slate': { name: 'Clean Slate', colors: ['#3b82f6', '#f8fafc', '#e2e8f0'] },
  'cosmic-night': { name: 'Cosmic Night', colors: ['#8b5cf6', '#0f0f1e', '#ff6b9d'] },
  'cyberpunk': { name: 'Cyberpunk', colors: ['#ff00ff', '#00ffff', '#ffff00'] },
  'darkmatter': { name: 'Dark Matter', colors: ['#7c3aed', '#0a0a0a', '#22d3ee'] },
  'doom-64': { name: 'Doom 64', colors: ['#ff4444', '#1a1a1a', '#44ff44'] },
  'elegant-luxury': { name: 'Elegant Luxury', colors: ['#d4af37', '#1a1a1a', '#f5f5f5'] },
  'graphite': { name: 'Graphite', colors: ['#6b7280', '#1f2937', '#9ca3af'] },
  'kodama-grove': { name: 'Kodama Grove', colors: ['#22c55e', '#ecfdf5', '#166534'] },
  'midnight-bloom': { name: 'Midnight Bloom', colors: ['#c026d3', '#1e1b4b', '#f0abfc'] },
  'mocha-mousse': { name: 'Mocha Mousse', colors: ['#9b7c49', '#b8a46f', '#a88d5f'] },
  'modern-minimal': { name: 'Modern Minimal', colors: ['#18181b', '#fafafa', '#71717a'] },
  'mono': { name: 'Mono', colors: ['#000000', '#ffffff', '#737373'] },
  'nature': { name: 'Nature', colors: ['#4ade80', '#f0fdf4', '#166534'] },
  'neo-brutalism': { name: 'Neo Brutalism', colors: ['#facc15', '#000000', '#ffffff'] },
  'northern-lights': { name: 'Northern Lights', colors: ['#22d3ee', '#1e293b', '#a78bfa'] },
  'notebook': { name: 'Notebook', colors: ['#3b82f6', '#fef9c3', '#f87171'] },
  'ocean-breeze': { name: 'Ocean Breeze', colors: ['#0ea5e9', '#f0f9ff', '#0369a1'] },
  'pastel-dreams': { name: 'Pastel Dreams', colors: ['#f9a8d4', '#fbcfe8', '#c4b5fd'] },
  'perpetuity': { name: 'Perpetuity', colors: ['#6366f1', '#0f172a', '#22d3ee'] },
  'quantum-rose': { name: 'Quantum Rose', colors: ['#f43f5e', '#fff1f2', '#be123c'] },
  'retro-arcade': { name: 'Retro Arcade', colors: ['#ea0093', '#00c2b9', '#fba628'] },
  'sage-garden': { name: 'Sage Garden', colors: ['#7ba876', '#a8c798', '#8fb88b'] },
  'soft-pop': { name: 'Soft Pop', colors: ['#f472b6', '#fce7f3', '#7c3aed'] },
  'solar-dusk': { name: 'Solar Dusk', colors: ['#f97316', '#fef3c7', '#ea580c'] },
  'starry-night': { name: 'Starry Night', colors: ['#6366f1', '#0c0a1d', '#fbbf24'] },
  'sunset-horizon': { name: 'Sunset Horizon', colors: ['#f97316', '#fdf4ff', '#ec4899'] },
  ...
  'vintage-paper': { name: 'Vintage Paper', colors: ['#92400e', '#fef3c7', '#d97706'] },
  'violet-bloom': { name: 'Violet Bloom', colors: ['#8b5cf6', '#faf5ff', '#c4b5fd'] },
};
